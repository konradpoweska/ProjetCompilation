...
Expression : Instance | Instantiation| Expression T_COMP Expression | Expression T_ADD Expression | Expression T_SUB Expression | Expression T_DIV Expression | Expression T_MULT Expression | T_ADD Expression %prec UNARY | T_SUB Expression %prec UNARY | Expression T_CONCAT Expression;
Selection : Instance'.'T_IDENT;
Instance : '('T_IDENTCLASS Expression ')' | T_IDENT | T_CONST | Selection | Message | T_STRING | '(' Expression')';
